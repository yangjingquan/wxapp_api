...
class CateringMallWxPay extends Controller{
    ...
    public function __construct()
    {
        ...
        $bis_id = $param['bis_id'];
        //获取db中配置内容
        $cfgRes = Db::table('cy_bis')->field('appid,mchid,key,notify_url')->where('id = '.$bis_id)->find();
        //设置配置内容
    ...
    public function getOutTradeInfoById($order_id){
        $res = Db::table('cy_mall_main_orders')->field('order_no,total_amount')->where('id = '.$order_id)->find();
        return $res;
    }
